...
import AdminHeaderBs from './AdminHeaderBs';
const menuItems = [
  { name: "Home", href: "/admin/pg" },
  
  { name: "Open Elective", href: "/admin/pg/openelective" },
  
  { name: "Logout", href: "/logout" },
];

function AdminHeaderPg() {
