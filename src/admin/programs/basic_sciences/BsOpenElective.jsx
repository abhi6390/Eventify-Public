...
function BsOpenElective() {
  ...
  return (
    ...
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-semibold text-slate-100 text-center">Basic Science Open Electives</h1>
